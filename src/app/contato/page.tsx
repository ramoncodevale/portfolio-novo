            ...
            <div className="flex flex-col gap-10 w-full lg:w-1/2">
              ...
              <div className="flex gap-2">
                ...
                <div>
                  ...
                  <a className="text-san-felix-950 hover:text-san-felix-800 hover:underline" href="https://www.github.com/ramoncodevale/" target="_blank" rel="nofollow">ramoncodevale</a>
                </div>
              </div>
              ...
              <div className="flex gap-2">
                ...
                <div>
                  ...
                  <a className="text-san-felix-950 hover:text-san-felix-800 hover:underline" href="https://www.linkedin.com/in/ramonvalentim88/" target="_blank" rel="nofollow">ramonvalentim</a>
                </div>
              </div>
            </div>
            ...
            <div className="w-full lg:w-1/2 bg-white shadow-lg p-8 rounded-lg">
              <form className="flex flex-col gap-6" onSubmit={handleSubmit}>
                <div className="flex flex-col gap-2">
                  ...
                  <input type="text" name="nome" value={formData.nome} onChange={handleChange} className="w-full bg-gray-100 p-3 rounded-md" required />
                </div>
                
                <div className="flex flex-col gap-2">
                  <label className="text-san-felix-950 font-bold">E-mail</label>
                  <input type="email" name="email" value={formData.email} onChange={handleChange} className="w-full bg-gray-100 p-3 rounded-md" required />
                </div>
                
                <div className="flex flex-col gap-2">
                  <label className="text-san-felix-950 font-bold">Mensagem</label>
                  <textarea name="mensagem" value={formData.mensagem} onChange={handleChange} className="w-full bg-gray-100 p-3 rounded-md h-32 resize-none" required></textarea>
                </div>
                
                <button type="submit" className="bg-san-felix-950 text-white p-3 rounded-md hover:bg-san-felix-800 transition">Enviar</button>
              </form>
            </div>
          </div>
        </div>
